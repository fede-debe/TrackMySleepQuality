...
// to declare a Binding Adapter, you just make a method that takes a view and some data. The binding adapter is responsible for updating the view to represent the data.
